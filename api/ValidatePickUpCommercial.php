...
$request->PartnerID = "";
$request->PickupInstruction->Date = "2010-03-24";
$request->PickupInstruction->AnyTimeAfter = "1200";
$request->PickupInstruction->UntilTime = "1400";
...
$response = $client->ValidatePickUp($request);
